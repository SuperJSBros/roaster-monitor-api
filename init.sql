...
CREATE TABLE IF NOT EXISTS public.batch (id bigserial NOT NULL, name character varying, weight float8 not NULL, origin character varying, PRIMARY KEY (id));
-- toggle daily_probe_id sequence to cycle at the end of its max value
ALTER SEQUENCE IF EXISTS public.probe_readings_daily_id_seq
    CYCLE;
